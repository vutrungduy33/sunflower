...
const requiredCurrentFacts = [
  'Current as of 2026-06-08 Round 116',
  'Round 99',
  ...
  'current `main`/`origin/main` alignment',
...
const staleText = [
  ...
  'Latest direct admin-web automated baseline: Round 96',
  'Latest direct miniapp automated baseline: Round 97',
  'Round 100 的 scripts/check_production_readonly_audit.sh 已通过',
  'Round 109 将这两条新事实刷新进 fresh-goal prompt',
  'Round 47',
  '33 unresolved',
  '33 项',
  '9 launch',
