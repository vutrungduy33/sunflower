...
check_node_syntax() {
  ...
  node --check "$ROOT_DIR/scripts/check_codeup_yunxiao_migration_plan.js"
...
check_codeup_yunxiao_migration_plan() {
  log INFO "checking Codeup/Yunxiao migration plan"
  node "$ROOT_DIR/scripts/check_codeup_yunxiao_migration_plan.js"
  log PASS "Codeup/Yunxiao migration plan checked"
}
